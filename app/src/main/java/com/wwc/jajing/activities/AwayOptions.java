...
public class AwayOptions extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    getWindow().setWindowAnimations(ZORDER_TOP);
		setContentView(R.layout.activity_away_options);

		// Initialize the UI componenets
		driving = (LinearLayout) findViewById(R.id.buttonDriving);
		family = (LinearLayout) findViewById(R.id.buttonFamily);
		meeting = (LinearLayout) findViewById(R.id.buttonMeeting);
		crowded = (LinearLayout) findViewById(R.id.buttonCrowded);
		call = (LinearLayout) findViewById(R.id.buttonImportantCall);
	...
	public void setEndTime(String anEndTime) {
		...
		if(!TimeSetting.isSartTimeInFuture(anEndTime)) {
			Toast.makeText(this, "end time must be in future", Toast.LENGTH_SHORT).show();
			return;
		}
