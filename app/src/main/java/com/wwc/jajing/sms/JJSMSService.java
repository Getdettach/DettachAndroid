...
public class JJSMSService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		Log.e("JJSMSService","onHandleIntent called");
		...
		Log.e(TAG, "phoneNumber:" + formattedIncomingNumber);
		
		if(jjSMSstr == null || formattedIncomingNumber == null ) return;
		
		Log.e(TAG, "A valid jjsms string was received. The rawSMSstr is:" + jjSMSstr);
