...
public class TimeSetting extends SugarRecord implements Entity {
    ...
    public TimeSetting(Context context, String startTime, String endTime, Days[] days,String status,int on) {             //use this cons for this project
        // super(context);
...
//    }
    ...
    public static boolean isValidTimeInterval(String aStartTime, String anEndTime) {
        ...
        System.out.println("aStartTime = " + aStartTime);
        System.out.println("anEndTime = " + anEndTime);
    ...
    public static boolean isSartTimeInFuture(String startTime) {
        Long endTimeMilli = TimeSetting.getDateOfTimeString(startTime).getTime();
        Long nowMilli = TimeSetting.getTimeNow().getTime();
        if (endTimeMilli > nowMilli) {
            return true;
        } else {
