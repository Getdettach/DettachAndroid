...
public class CallsModelRealmProxy extends CallsModel
    ...
    public String getCalldate() {
        realm.checkIfValid();
        return (java.lang.String) row.getString(INDEX_CALLDATE);
    }

    @Override
    public void setCalldate(String value) {
        realm.checkIfValid();
        row.setString(INDEX_CALLDATE, (String) value);
    }
    ...
    public static void validateTable(ImplicitTransaction transaction) {
        if (transaction.hasTable("class_CallsModel")) {
            ...
            for (String fieldName : getFieldNames()) {
                ...
                if (index == -1) {
                    throw new RealmMigrationNeededException(transaction.getPath(), "Field '" + fieldName + "' not found for type CallsModel");
                }
            ...
            INDEX_CALLDATE = table.getColumnIndex("calldate");
            ...
            if (!columnTypes.containsKey("calldate")) {
                throw new RealmMigrationNeededException(transaction.getPath(), "Missing field 'calldate'");
            }
            if (columnTypes.get("calldate") != ColumnType.STRING) {
                throw new RealmMigrationNeededException(transaction.getPath(), "Invalid type 'String' for field 'calldate'");
            }
            ...
            throw new RealmMigrationNeededException(transaction.getPath(), "The CallsModel class is missing from the schema for this Realm.");
        }
    }
    ...
    public static CallsModel createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        CallsModel obj = realm.createObject(CallsModel.class);
        if (json.has("number")) {
        ...
        if (json.has("calldate")) {
            if (json.isNull("calldate")) {
                obj.setCalldate("");
            } else {
                obj.setCalldate((String) json.getString("calldate"));
            }
        }
    ...
    public static CallsModel createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        CallsModel obj = realm.createObject(CallsModel.class);
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (name.equals("number")) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    obj.setCalldate((String) reader.nextString());
                }
    ...
    public static CallsModel copyOrUpdate(Realm realm, CallsModel object, boolean update, Map<RealmObject,RealmObjectProxy> cache) {
    ...
    public static CallsModel copy(Realm realm, CallsModel newObject, boolean update, Map<RealmObject,RealmObjectProxy> cache) {
        CallsModel realmObject = realm.createObject(CallsModel.class);
        ...
        realmObject.setCalldate(newObject.getCalldate() != null ? newObject.getCalldate() : "");
    ...
    static CallsModel update(Realm realm, CallsModel realmObject, CallsModel newObject, Map<RealmObject, RealmObjectProxy> cache) {
        realmObject.setNumber(newObject.getNumber() != null ? newObject.getNumber() : "");
        realmObject.setType(newObject.getType() != null ? newObject.getType() : "");
        realmObject.setTime(newObject.getTime() != null ? newObject.getTime() : "");
        realmObject.setCalldate(newObject.getCalldate() != null ? newObject.getCalldate() : "");
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("CallsModel = [");
        ...
        stringBuilder.append("}");
        stringBuilder.append(",");
        stringBuilder.append("{calldate:");
        stringBuilder.append(getCalldate());
        stringBuilder.append("}");
        stringBuilder.append(",");
    ...
    public boolean equals(Object o) {
        ...
        CallsModelRealmProxy aCallsModel = (CallsModelRealmProxy)o;

        String path = realm.getPath();
        String otherPath = aCallsModel.realm.getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;;

        String tableName = row.getTable().getName();
        String otherTableName = aCallsModel.row.getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (row.getIndex() != aCallsModel.row.getIndex()) return false;
